            ...
            <div className="card p-6">
                ...
                <div className="mt-4">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-4">
                        <div className="bg-[#1f2937] border border-gray-700 rounded-md p-3">
                            <div className="text-sm text-red-400 font-medium">Predators</div>
                            <div className="text-2xl font-bold text-red-300">{statistics.predator_count || 0}</div>
                        </div>
                        <div className="bg-[#1f2937] border border-gray-700 rounded-md p-3">
                            <div className="text-sm text-yellow-400 font-medium">Prey</div>
                            <div className="text-2xl font-bold text-yellow-300">{statistics.prey_count || 0}</div>
                        </div>
                        <div className="bg-[#1f2937] border border-gray-700 rounded-md p-3">
                            <div className="text-sm text-green-400 font-medium">Substrate</div>
                            <div className="text-2xl font-bold text-green-300">{statistics.substrate_count || 0}</div>
                        </div>
                    </div>
                    <div className="bg-[#1f2937] border border-gray-700 rounded-md p-3">
                        <div className="text-sm text-gray-400 font-medium">Total Population</div>
