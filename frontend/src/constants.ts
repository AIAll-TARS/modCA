...
let GRID_SIZE = 75;
let STEPS = 9999;
let NEIGHBORHOOD_TYPE = "moore";
let GRID_TYPE = "finite";
let PREDATOR_DEATH_PROBABILITY = 0.1;
let PREDATOR_BIRTH_PROBABILITY = 0.43;
let INITIAL_PREDATORS = 20;
let PREDATOR_STARVATION_STEPS = 66;
let PREY_HUNTED_PROBABILITY = 0.3;
let PREY_RANDOM_DEATH = 0.1;
let INITIAL_PREY = 1000;
let PREY_BIRTH_PROBABILITY = 0.64;
let PREY_STARVATION_STEPS = 3;
let PREY_THREAT_RESPONSE = 0.5;
let INITIAL_SUBSTRATE_PROBABILITY = 0.3;
let SUBSTRATE_RANDOM_DEATH = 0.1;
let SUBSTRATE_CONSUMPTION_PROB = 0.3;

// Function to update constants from backend
export const updateConstants = (constants: SimulationConstants) => {
